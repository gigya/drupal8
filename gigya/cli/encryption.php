...
function get_available_commands() {
  return [
    [
      'command' => 'e',
      'description' => 'Encrypt',
      'function' => '\Drupal\gigya\CmsStarterKit\GigyaApiHelper::enc',
      'arg_count' => 2,
      'check_args' => FALSE,
    ],
    [
      'command' => 'd',
      'description' => 'Decrypt',
      'function' => '\Drupal\gigya\CmsStarterKit\GigyaApiHelper::decrypt',
      'arg_count' => 2,
      'check_args' => FALSE,
    ],
    [
      ...
      'function' => '\Drupal\gigya\CmsStarterKit\GigyaApiHelper::genKeyFromString',
      'arg_count' => 1,
      'check_args' => TRUE,
    ],
    [
