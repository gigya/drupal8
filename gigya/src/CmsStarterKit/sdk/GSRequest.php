...
class GSRequest {
   ...
   *   example: socialize.getUserInfo If namespaces is not supplied "socialize"
   *   is assumed
   * @param GSObject $params the request parameters
   * @param bool $useHTTPS useHTTPS set this to true if you want to use HTTPS.
   * @param string $userKey userKey A key of an admin user with extra
   *   permissions. If this parameter is provided, then the secretKey parameter
   *   is assumed to be the admin user's secret key and not the site's secret
   *   key.
   *
   * @throws \Exception
   */
  ...
  /**
   * Sets the domain used for making API calls. This method provides the option
   * to override the default domain "gigya.com" and specify an alternative data
   * center to be used.
   *
   * @param string $apiDomain - the domain of the data center to be used. For
   *   example: "eu1.gigya.com" for Europe data center.
   */
